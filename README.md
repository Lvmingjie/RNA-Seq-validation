...
<b>Complete-PrimerBestPairs-data.txt</b> file contains the principal results, each line presents the best transcripts identified and RNA-Seq product Sizes that are associated with each HR-RTPCR primer product Size. Example of this file:
